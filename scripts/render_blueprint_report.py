...
EXPECTED_WEB_SERVICES: dict[str, dict[str, Any]] = {
    "start": {
        ...
        "envVarSpecs": {
            ...
            "STRIPE_WEBHOOK_JOB_EXPIRES_SECONDS": {"value": "604800"},
            "USAGE_LOG_JOB_EXPIRES_SECONDS": {"value": "604800"},
            "RUN_BILLING_SCHEDULER_IN_API": {"value": "false"},
            "TOOL_GATEWAY_SIGNING_PRIVATE_KEY": {"sync": False},
            "TOOL_GATEWAY_SIGNING_KEY_ID": {"value": "launch-1"},
            "TOOL_GATEWAY_SIGNATURE_TTL_SECONDS": {"value": "300"},
            ...
            "ALERT_STRIPE_WEBHOOK_STALE_AFTER_SECONDS": {"value": "900"},
            "ALERT_FAILED_STRIPE_WEBHOOKS_THRESHOLD": {"value": "1"},
            "ALERT_FAILED_STRIPE_WEBHOOKS_WINDOW_SECONDS": {"value": "900"},
            ...
            "REPO_ANALYSIS_RATE_LIMIT_PER_HOUR": {"value": "5"},
            "REPO_ANALYSIS_LOCK_SECONDS": {"value": "180"},
    ...
    "home-accessibility-checker": {
        ...
        "envVarKeys": [
            ...
            "OPENROUTER_MODEL",
            "NODE_ENV",
            "HACKMARKET_GATEWAY_PUBLIC_KEY",
            "HACKMARKET_GATEWAY_KEY_ID",
            "HACKMARKET_GATEWAY_SIGNATURE_TTL_SECONDS",
            "HACKMARKET_TOOL_SLUG",
        ...
        "envVarSpecs": {
            ...
            "HACKMARKET_GATEWAY_PUBLIC_KEY": {"sync": False},
            "HACKMARKET_GATEWAY_KEY_ID": {"value": "launch-1"},
            "HACKMARKET_GATEWAY_SIGNATURE_TTL_SECONDS": {"value": "300"},
            "HACKMARKET_TOOL_SLUG": {"value": "home-accessibility-checker"},
            "ALLOW_UNSIGNED_GATEWAY_REQUESTS": {"value": "false"},
